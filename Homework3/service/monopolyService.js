...
function readPlayerGameID(req, res, next) {
    db.many('SELECT * FROM PlayerGame WHERE gameid=${id}', req.params)
        .then(data => {
            res.send(data);
        })
        .catch(err => {
...
function readPlayerIDGame(req, res, next) {
    db.many('SELECT * FROM PlayerGame WHERE playerid=${id}', req.params)
        .then(data => {
            res.send(data);
        })
        .catch(err => {
